...
const ProductItemComponent = ({product}) => {
  ...
  return (
    <div className={`${classes.productItem} mb-40`}>
      <div className='row'>
        <div className='col-md-7'>
          <h3 className={classes.productItemTitle}>{product.about.title}</h3>
          ...
          <div className={`${classes.productDetailBtn} mt-40`}>
            <NavLink to={`${Routes.productdetail}/${product.id}`}>
              <button className={classes.detailBtn}>
                <span className='mr-8'>{translate('productDetailBtn')}</span>
